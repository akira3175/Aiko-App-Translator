...
from services.cloudflare import chapter_groups, chapter_identity, merged_markdown
...
class ShareSegmentTests(unittest.TestCase):
    def test_groups_and_merges_segments_in_numeric_order(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            groups = chapter_groups([segment_two, segment_one])
            ...
            content, title = merged_markdown(groups[0]["paths"])
    ...
    def test_recognizes_old_segment_and_new_merged_names_as_same_chapter(self):
        self.assertEqual(chapter_identity("v2_c10_s3.md"), (2, 10))
        self.assertEqual(chapter_identity("v2_c10.md"), (2, 10))
        self.assertIsNone(chapter_identity("ghi-chu.md"))
