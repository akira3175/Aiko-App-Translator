...
Copy-Item -LiteralPath (Join-Path $root "web\assets\anime\aiko-launcher-background.png") -Destination $assetOutput -Force
Copy-Item -LiteralPath (Join-Path $root "web\assets\anime\aiko-blue-logo.png") -Destination $assetOutput -Force
